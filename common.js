...
const excel = await database.readExcelData({path:'C:\\Users\\RY214ZU\\Downloads\\Webdriverpractise\\Webdriverpractise\\test\Data\\CreatePurchaseOrder.xlsx', sheet_no:"1", column:['Parameter','Value'],start_row:"1", end_row:"10", skip_rows:[]});
console.log(excel)
